...
class NewReminder extends Component {
  ...
  handleFormSubmit = e => {
    ...
    e.preventDefault ();
    axios
      .post ('http://localhost:6001/reminders/create', this.state)
      .then (response => {
        ...
        <div>
          <form onSubmit={this.handleFormSubmit}>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-10" onChange={e => this.handleEntry (e)}>
                <select name="remindMe" className="form-control" id="remindme">
                  <option value="">Please choose reminder alert time:</option>
